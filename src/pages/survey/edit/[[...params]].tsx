...
export default function TransferSurveyEdit() {
  ...
  console.log(params.surveyType);
  let process = Number(params.process);
  useEffect(() => {
    DivideQuestionHandler(params.surveyType);
  });
  ...
  // 주택 or 토지 질문별로 구분로직
  const DivideQuestionHandler = (type?: any) => {
    if (type === "주택") {
